...
const contactInfo = [
  ...
  },
  {
    icon: Phone,
    title: "Phone Number",
    details: ["+254 726 931076"],
  },
  {
    icon: Mail,
    title: "Email Address",
    details: ["info@scafkenya.org", "support@scafkenya.org"],
  },
  {
    icon: Clock,
    title: "Office Hours",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Whether you want to volunteer, donate, or learn more about our work,
            {"we're"} here to help.
          </p>
        </div>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-primary p-8 rounded-2xl text-primary-foreground">
              ...
              <p className="opacity-90 mb-6">
                Stay connected with us on social media for updates, stories, and
              ...
              <p className="mt-4 text-sm opacity-70">#SickleCellAwarenessKE</p>
            </div>
          </div>
        </div>
      </div>
